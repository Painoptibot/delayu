...
document.addEventListener('DOMContentLoaded', function () {
  var modalEl = document.getElementById('intMsgModal');
  var bodyEl = document.getElementById('intMsgModalBody');
  if (!modalEl || !bodyEl) return;
  var modal = bootstrap.Modal.getOrCreateInstance(modalEl);
  document.querySelectorAll('.int-msg-open').forEach(function (btn) {
