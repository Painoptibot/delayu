      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full) {
            return `<a href="/app/invoice/preview/">#${full['invoice_id']}</a>`;
          }
        },
        {
        ...
        },
        {
          ...
          render: function () {
            return (
              ...
              '<a href="/app/invoice/preview/" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light" data-bs-placement="top" title="Preview Invoice"><i class="icon-base ri ri-eye-line icon-20px"></i></a>' +
              '<div class="dropdown">' +
