...
MENU_SECTIONS = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"url_name": "invest-inbox", "codes": ["M22"], "icon": "ri-inbox-line", "label": "Сегодня"},
            ...
            {"url_name": "invest-extracts", "codes": ["M22"], "icon": "ri-file-paper-2-line", "label": "Выписки"},
            {"url_name": "invest-fgistp", "codes": ["M22"], "icon": "ri-building-4-line", "label": "ФГИС ТП"},
            {"url_name": "invest-opendata-catalog", "codes": ["M22"], "icon": "ri-database-2-line", "label": "Открытые данные"},
