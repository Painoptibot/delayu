...
THEME_VARIABLES = {
    "creator_name": "Югит",
    "creator_url": "https://yugit.ru/",
    "template_name": "ДелаЮ",
    "template_suffix": "Платформа Дела.ЮГИт",
    ...
    "og_title": "Materialize Bootstrap 5 HTML + Django Admin Template by Pixinvent",
    "og_image": "https://ts-assets.b-cdn.net/pi-assets/materialize/admin-template/banner/banner.png",
    "og_type": "product",
}
